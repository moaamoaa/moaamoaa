...
public class SearchService {
	...
	public void checkIsNotNull(SearchCondition condition) {
		if (condition.getArea() != null && condition.getArea().size() == 0) {
			condition.setArea(null);
		}
		if (condition.getStack() != null && condition.getStack().size() == 0) {
			condition.setStack(null);
		}
	}
