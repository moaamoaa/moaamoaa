...
public class MatchingController {
	...
	public ResponseEntity<?> showReceiveApply(@RequestBody MatchingForm matchingForm, Authentication authentication) throws
		Exception {
		UserDetails userDetails = (UserDetails)authentication.getPrincipal();
	...
	@PostMapping("/offer")
	public ResponseEntity<?> sendOffer(@RequestBody MatchingForm matchingForm, Authentication authentication) throws Exception {
		UserDetails userDetails = (UserDetails)authentication.getPrincipal();
		if(!teamService.checkLeader(Long.valueOf(userDetails.getUsername()), matchingForm.getProjectId()))
		{
			throw new Exception("팀장이 아닙니다.");
